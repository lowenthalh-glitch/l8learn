(function() {
    'use strict';
    window.MobileCollabGroups = window.MobileCollabGroups || {};

    MobileCollabGroups.enums = {
    ...
    var enums = MobileCollabGroups.enums;

    MobileCollabGroups.render = {
        groupType: function(v) { return enums.GROUP_TYPE[v] || v; },
        groupStatus: Layer8MRenderers.createStatusRenderer(enums.GROUP_STATUS, enums.GROUP_STATUS_CLASSES),
    ...
    MobileCollabGroups.primaryKeys = {
        CollabGroup: 'groupId',
        TutorMatch: 'matchId',
