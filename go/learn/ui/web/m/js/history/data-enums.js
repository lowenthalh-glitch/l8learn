(function() {
    'use strict';
    window.MobileDataHistory = window.MobileDataHistory || {};

    MobileDataHistory.enums = {
    ...
    var enums = MobileDataHistory.enums;

    MobileDataHistory.render = {
        growthRating: Layer8MRenderers.createStatusRenderer(enums.GROWTH_RATING, enums.GROWTH_RATING_CLASSES),
        riskLevel: Layer8MRenderers.createStatusRenderer(enums.RISK_LEVEL, enums.RISK_LEVEL_CLASSES),
