(function() {
    'use strict';
    window.MobileAdaptiveLearning = window.MobileAdaptiveLearning || {};

    MobileAdaptiveLearning.enums = {
    ...
    var enums = MobileAdaptiveLearning.enums;

    MobileAdaptiveLearning.render = {
        masteryLevel: Layer8MRenderers.createStatusRenderer(enums.MASTERY_LEVEL, enums.MASTERY_LEVEL_CLASSES),
        pathStatus: Layer8MRenderers.createStatusRenderer(enums.PATH_STATUS, enums.PATH_STATUS_CLASSES),
        ...
        ruleStatus: Layer8MRenderers.createStatusRenderer(enums.RULE_STATUS, enums.RULE_STATUS_CLASSES)
    };

    MobileAdaptiveLearning.primaryKeys = {
        Skill: 'skillId',
