(function() {
    ...
    var render = MobileAdaptiveLearning.render;

    MobileAdaptiveLearning.columns = {
        Skill: [
            ...col.id('skillId'),
            ...col.col('name', 'Name'),
    ...
    MobileAdaptiveLearning.columns.Skill[1].primary = true;
    MobileAdaptiveLearning.columns.Skill[2].secondary = true;
    MobileAdaptiveLearning.columns.SkillMastery[1].primary = true;
    MobileAdaptiveLearning.columns.SkillMastery[3].secondary = true;
    MobileAdaptiveLearning.columns.LearningPath[1].primary = true;
    MobileAdaptiveLearning.columns.LearningPath[3].secondary = true;
    MobileAdaptiveLearning.columns.AdaptationRule[1].primary = true;
    MobileAdaptiveLearning.columns.AdaptationRule[2].secondary = true;
})();
