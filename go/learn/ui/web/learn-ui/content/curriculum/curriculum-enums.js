(function() {
    'use strict';
    window.ContentCurriculum = window.ContentCurriculum || {};

    ContentCurriculum.enums = {
    ...
    ContentCurriculum.render = {
        ...
        status: Layer8DRenderers.createStatusRenderer(enums.STATUS, enums.STATUS_CLASSES),
        activityType: function(v) { return enums.ACTIVITY_TYPE[v] || v; }
    };

    ContentCurriculum.primaryKeys = {
        Course: 'courseId',
        Unit: 'unitId',
        Lesson: 'lessonId',
        Activity: 'activityId',
