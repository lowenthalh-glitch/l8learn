(function() {
    'use strict';
    window.AnalyticsReports = window.AnalyticsReports || {};

    AnalyticsReports.enums = {
    ...
    var enums = AnalyticsReports.enums;

    AnalyticsReports.render = {
        reportPeriod: function(v) { return enums.REPORT_PERIOD[v] || v; },
        engagementLevel: Layer8DRenderers.createStatusRenderer(enums.ENGAGEMENT_LEVEL, enums.ENGAGEMENT_LEVEL_CLASSES),
        subject: function(v) { return enums.SUBJECT[v] || v; }
    };

    AnalyticsReports.primaryKeys = {
